-- =====================================================================
-- AI Mock Interview Platform — SQLite test schema
-- Generic TEXT/INTEGER/REAL types (mirrors docs/api/DATABASE_SCHEMA.sql,
-- which targets SQL Server / Azure SQL for production).
-- =====================================================================
